import { validateNonEmptyString, validatePositiveNumber, validatePositiveInteger, validateFloat, validateDuration, } from './validators.js';
describe('Validators Unit Tests', () => {
    ...
    describe('validatePositiveNumber', () => {
        ...
        it('should return error for undefined', () => {
            expect(validatePositiveNumber(undefined)).toBe('Must be a positive number.');
        });
    });
